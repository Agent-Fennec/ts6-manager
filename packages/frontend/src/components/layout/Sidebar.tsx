...
import {
  ...
  ScrollText, Settings, Bot, Cpu, ChevronLeft, ChevronRight, Music, ListMusic, Image,
} from 'lucide-react';
...
const navSections = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/banners', icon: Image, label: 'Banners', adminOnly: true },
    ],
  },
];
        ...
        <div className="border-t border-sidebar-border p-2 space-y-1">
          ...
          {!sidebarCollapsed && (
            <button
              ...
              className="w-full text-[10px] font-mono-data text-sidebar-foreground/30 hover:text-sidebar-foreground/60 transition-colors text-center pt-1"
            >
              v{APP_VERSION}
            </button>
          )}
