    ...
    <div className="min-h-screen flex items-center justify-center bg-background grid-bg">
      ...
      <div className="w-full max-w-sm mx-4 relative">
        ...
        <button
          ...
          className="text-center text-[10px] text-muted-foreground/50 mt-6 font-mono-data hover:text-muted-foreground/80 transition-colors block w-full"
        >
          TS6 WEBUI v{APP_VERSION}
        </button>
      </div>
